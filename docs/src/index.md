...
[![License](https://img.shields.io/github/license/ohno/MyPkg56.jl)](https://github.com/ohno/MyPkg56.jl/blob/main/LICENSE)
...
```julia
import Pkg; Pkg.add(url="https://github.com/ohno/MyPkg56.jl.git")
```

After installation, run the following to load the package and verify it works:

```@repl
import MyPkg56; MyPkg56.hello()
```
